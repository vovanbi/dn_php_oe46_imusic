...
@section('content')
    <div class="container-fluid">
        ...
        <div class="table-responsive">
            <h3>
                @lang('album.albSongManage')<a href="{{ route('albumSong', ['album' => $album->id]) }}"><i class="fa fa-plus-circle"></i></a>
            </h3>
                    ...
                    @if (isset($songs))
                        @foreach ($songs as $song)
                            <tr id="song-{{ $song->id }}">
                                ...
                                <td> 
                                    <a class="btn btn-success add-album-song" data-song = "{{ $song->id }}" data-album= "{{ $album->id }}" href="">
