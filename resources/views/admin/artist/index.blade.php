                    ...
                    @if (isset($artists))
                        @foreach ($artists as $artist)
                            <tr id="artist-{{ $artist->id }}">
                                ...
                                <td>
                                    <a class="btn btn-info btn-info-artist"
                                        href="{{ route('artist.edit', $artist->id) }}"><i class="fa fa-pencil"></i>
                                        @lang('artist.edit')</a>
                                    <a class="btn btn-danger btn-delete-artist" data-id="{{ $artist->id }}"><i
