<div class="music">
    ...
    <div class="recently_played">
        <h2 class="search-more">@lang('homePage.searchSong') <i class="fa fa-chevron-right" aria-hidden="true"></i></h2>
        <div class="row">
            @if (count($songs) > 0)
    ...
    <div class="album">
        <h2 class="search-more">@lang('homePage.searchAlbum') <i class="fa fa-chevron-right" aria-hidden="true"></i></h2>
        <div class="row">
            @if (count($albums) > 0)
    ...
    <div class="artist">
        <h2 class="search-more">@lang('homePage.artistSong') <i class="fa fa-chevron-right" aria-hidden="true"></i></h2>
        <div class="row">
            @if (count($artists) > 0)
